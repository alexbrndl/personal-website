...
client: FitTrack
cover: /images/fitness-cover.jpg
date: 2025-09-15
description: Design et développement d'une application mobile de suivi fitness avec des visualisations de données en temps réel.
featured: true
gallery:
  - type: image
    src: /images/fitness-screens.jpg
    alt: Écrans de l'application
    caption: Les écrans principaux de l'application
role: Lead Developer
tags:
  - React Native
  - TypeScript
